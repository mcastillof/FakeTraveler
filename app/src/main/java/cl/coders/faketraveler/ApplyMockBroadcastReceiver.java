...
public class ApplyMockBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        try {
            ...
            Toast.makeText(context, "Mocked location not applied. You must enable mock location in developer settings. Service stoped.", Toast.LENGTH_LONG).show();
        ...
        else
        {
            ...
            {
                Toast.makeText(context, "Fake Traveler was closed. Mock location stoped.", Toast.LENGTH_LONG).show();
            }
